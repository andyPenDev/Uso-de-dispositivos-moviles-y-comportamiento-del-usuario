...
2.2. Análisis Exploratorio de Datos (EDA) Métodos y herramientas utilizadas para el EDA. 

Incluye técnicas para la exploración de datos, visualización, y manejo de valores faltantes y atípicos.  
